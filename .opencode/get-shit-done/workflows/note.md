...
- **Global scope**: `/home/natan/workspace/Site-Tibia/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/natan/workspace/Site-Tibia/.opencode/notes/`)
...
2. Glob `/home/natan/workspace/Site-Tibia/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/natan/workspace/Site-Tibia/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/natan/workspace/Site-Tibia/.opencode/notes/` — works in any directory
