...
<!-- For checkpoint task examples and patterns, see @D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/references/checkpoints.md -->
...
See `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
