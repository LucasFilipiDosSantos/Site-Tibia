...
- Usage: Reference from command with `@D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
