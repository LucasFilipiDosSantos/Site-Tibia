...
<required_reading>
@D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/references/domain-probes.md
@D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/references/gate-prompts.md
@D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/workflows/discuss-phase-power.md
