...
```bash
node "D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/templates/retrospective.md`.
