...
<required_reading>
@D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/references/ai-frameworks.md
@D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/agents/gsd-eval-planner.md for instructions.
