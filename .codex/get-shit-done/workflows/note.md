...
- **Global scope**: `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/notes/`)
...
2. Glob `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/notes/*.md` (if directory exists) — global notes
...
Global (D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/notes/` — works in any directory
