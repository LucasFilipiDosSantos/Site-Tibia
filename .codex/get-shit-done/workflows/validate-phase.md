...
```
Task(
  prompt="Read D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/TRAMPO/clientes/TibiaWebSite/lootera-marketplace-gamer/.codex/get-shit-done/templates/VALIDATION.md`
