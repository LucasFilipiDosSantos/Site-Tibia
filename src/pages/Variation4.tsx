...
const Variation4 = () => {
  return (
    <div className="min-h-screen bg-background">
      {/* Header — V1 commercial style */}
      <Header variant="commercial" />

      {/* Hero Banner — V2 structure (full bleed, no rounded) + V1 overlay style + new image */}
      <section className="relative">
        <div className="relative h-[260px] overflow-hidden lg:h-[420px]">
          <img
            src={heroBanner}
            alt="Lootera - Marketplace"
      ...
      {/* Categories — V1 commercial style */}
      <CategoryGrid variant="commercial" />

      {/* Server & Service Cards — V2 layout (3-col grid) + V1 commercial style */}
      <section className="pb-10 lg:pb-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:gap-6">
            <ServerCard serverName="NOME DO MUNDO SERVER" variant="commercial" />
            <ServerCard
      ...
      {/* Trust bar — V2 layout + V1 commercial colors */}
